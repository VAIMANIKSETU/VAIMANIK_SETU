  ...
  return (
    <Panel title="Simulation Controls">
      <div className="mb-4 grid gap-3 md:grid-cols-3">
        <label className="rounded-md border border-white/10 bg-white/[0.03] p-3 text-sm text-slate-300">
          <span className="mb-2 block text-xs uppercase tracking-[0.14em] text-slate-500">Attack Type</span>
          <select
            className="w-full rounded-md border border-white/10 bg-obsidian px-3 py-2 text-slate-100 outline-none"
      ...
      <div className="mb-4 grid gap-2 sm:grid-cols-3">
        <button
          type="button"
          onClick={startAttack}
          className="flex items-center justify-center gap-2 rounded-md border border-danger/35 bg-danger/12 px-3 py-3 text-sm font-semibold text-red-100 transition hover:border-danger"
        >
          <PlayCircle size={16} />
          Start Attack
        </button>
        <button
          type="button"
          onClick={stopAttack}
          className="flex items-center justify-center gap-2 rounded-md border border-limepulse/35 bg-limepulse/10 px-3 py-3 text-sm font-semibold text-limepulse transition hover:border-limepulse"
        >
          <PauseCircle size={16} />
          Stop Attack
        </button>
